...
namespace WebCamLib
{
	...
	{
		Pan_degrees = (int)WebCamLib::CameraControlProperty::Pan_degrees | (int)PropertyTypeMask::CameraControlPropertyMask,
		Tilt_degrees = (int)WebCamLib::CameraControlProperty::Tilt_degrees | (int)PropertyTypeMask::CameraControlPropertyMask,
		Roll_degrees = (int)WebCamLib::CameraControlProperty::Roll_degrees | (int)PropertyTypeMask::CameraControlPropertyMask,
		Zoom_mm = (int)WebCamLib::CameraControlProperty::Zoom_mm | (int)PropertyTypeMask::CameraControlPropertyMask,
		Exposure_lgSec = (int)WebCamLib::CameraControlProperty::Exposure_lgSec | (int)PropertyTypeMask::CameraControlPropertyMask,
		Iris_10f = (int)WebCamLib::CameraControlProperty::Iris_10f | (int)PropertyTypeMask::CameraControlPropertyMask,
		FocalLength_mm = (int)WebCamLib::CameraControlProperty::FocalLength_mm | (int)PropertyTypeMask::CameraControlPropertyMask,
		Flash = (int)WebCamLib::CameraControlProperty::Flash | (int)PropertyTypeMask::CameraControlPropertyMask,
		Brightness = (int)WebCamLib::VideoProcAmpProperty::Brightness | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		Contrast = (int)WebCamLib::VideoProcAmpProperty::Contrast | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		Hue = (int)WebCamLib::VideoProcAmpProperty::Hue | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		Saturation = (int)WebCamLib::VideoProcAmpProperty::Saturation | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		Sharpness = (int)WebCamLib::VideoProcAmpProperty::Sharpness | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		Gamma = (int)WebCamLib::VideoProcAmpProperty::Gamma | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		ColorEnable = (int)WebCamLib::VideoProcAmpProperty::ColorEnable | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		WhiteBalance = (int)WebCamLib::VideoProcAmpProperty::WhiteBalance | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		BacklightCompensation = (int)WebCamLib::VideoProcAmpProperty::BacklightCompensation | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
		Gain = (int)WebCamLib::VideoProcAmpProperty::Gain | (int)PropertyTypeMask::VideoProcAmpPropertyMask,
	};
